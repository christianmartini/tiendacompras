...
function ItemDetailContainer ({id}){
    ...
    useEffect(() => {
    let findItem = new Promise((resolve) => {
        setTimeout(() => {
             resolve(productos); //Tengo que buscar el ID correcto dentro de productos para solo devolver esos detalles.
         }, 2000);
        })
         findItem.then((res)=> setItemdet(res))
       }, [])
